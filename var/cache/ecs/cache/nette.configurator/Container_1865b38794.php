...
// source: phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level8.neon
...
class Container_1865b38794 extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'additionalConfigFiles' => [
				'phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level8.neon',
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_1865b38794 $container)
			{
	...
	public function createServiceContainer(): Container_1865b38794
	{
		return $this;
	}
