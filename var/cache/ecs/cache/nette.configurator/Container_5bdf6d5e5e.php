...
class Container_5bdf6d5e5e extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_5bdf6d5e5e $container)
			{
	...
	public function createServiceContainer(): Container_5bdf6d5e5e
	{
		return $this;
	}
