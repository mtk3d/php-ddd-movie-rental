...
class Container_37b7183a96 extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_37b7183a96 $container)
			{
	...
	public function createServiceContainer(): Container_37b7183a96
	{
		return $this;
	}
