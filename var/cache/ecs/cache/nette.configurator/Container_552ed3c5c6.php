...
class Container_552ed3c5c6 extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_552ed3c5c6 $container)
			{
	...
	{
		return new PHPStan\Rules\FunctionCallParametersCheck($this->getService('092'), false, false, true, false);
	}
	...
	public function createServiceContainer(): Container_552ed3c5c6
	{
		return $this;
	}
