...
class Container_cc754ba48b extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_cc754ba48b $container)
			{
	...
	public function createServiceContainer(): Container_cc754ba48b
	{
		return $this;
	}
