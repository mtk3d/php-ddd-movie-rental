...
class Container_1922c6d466 extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_1922c6d466 $container)
			{
	...
	{
		return new PHPStan\Rules\FunctionCallParametersCheck($this->getService('092'), true, true, true, false);
	}
	...
	public function createServiceContainer(): Container_1922c6d466
	{
		return $this;
	}
