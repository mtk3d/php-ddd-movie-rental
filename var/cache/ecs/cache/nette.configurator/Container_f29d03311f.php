...
// source: phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level5.neon
...
class Container_f29d03311f extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'additionalConfigFiles' => [
				'phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level5.neon',
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_f29d03311f $container)
			{
	...
	public function createServiceContainer(): Container_f29d03311f
	{
		return $this;
	}
