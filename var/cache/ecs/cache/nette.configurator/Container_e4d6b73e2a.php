...
class Container_e4d6b73e2a extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_e4d6b73e2a $container)
			{
	...
	public function createServiceContainer(): Container_e4d6b73e2a
	{
		return $this;
	}
