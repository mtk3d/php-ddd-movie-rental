...
// source: phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level3.neon
...
class Container_c4f157b4e5 extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0210']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'additionalConfigFiles' => [
				'phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level3.neon',
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_c4f157b4e5 $container)
			{
	...
	public function createService0210(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	public function createServiceContainer(): Container_c4f157b4e5
	{
		return $this;
	}
	...
	{
		return $this->getService('0210')->create();
	}
