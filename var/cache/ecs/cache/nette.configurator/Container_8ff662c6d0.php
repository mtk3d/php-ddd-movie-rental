...
// source: phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level7.neon
...
class Container_8ff662c6d0 extends _HumbugBox71425477b33d\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [2 => ['rules.75']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [2 => ['rules.76']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [2 => ['rules.77']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [2 => ['rules.78']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [2 => ['rules.79']],
		...
		'PHPStan\Rules\Functions\RandomIntParametersRule' => [['0229']],
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0230']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'additionalConfigFiles' => [
				'phar:///Users/mateuszcholewka/Sites/MovieRental/vendor/phpstan/phpstan/phpstan/conf/config.level7.neon',
	...
	public function createService054(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_8ff662c6d0 $container)
			{
	...
	{
		return new PHPStan\Rules\FunctionCallParametersCheck($this->getService('092'), true, true, true, true);
	}
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), false, false, true);
	}
	...
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('078'), $this->getService('092'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule($this->getService('090'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('092'), true);
	}
	...
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('092'), true);
	}
	...
	public function createService0229(): PHPStan\Rules\Functions\RandomIntParametersRule
	{
		return new PHPStan\Rules\Functions\RandomIntParametersRule($this->getService('reflectionProvider'), true);
	}


	public function createService0230(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	public function createServiceContainer(): Container_8ff662c6d0
	{
		return $this;
	}
	...
	public function createServiceRules__75(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('087'));
	}


	public function createServiceRules__76(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('087'));
	}


	public function createServiceRules__77(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('087'));
	}


	public function createServiceRules__78(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('087'));
	}


	public function createServiceRules__79(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('087'));
	}
	...
	{
		return $this->getService('0230')->create();
	}
